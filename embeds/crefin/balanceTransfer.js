...
document.addEventListener("click", (e) => {
  if (e.target.classList.contains("calcExistingLoan")) {
    ...
    // ✅ Show Add button only if fewer than 4 loans exist
    const loanCount = document.querySelectorAll(".existing-loan").length;
    if (loanCount < 4) {
      addBtn.classList.remove("hidden");
    }
  }
...
if (savings > 0) {
  ...
  amountEl.className = "text-2xl font-extrabold text-green-600";
  titleEl.className = "text-base font-bold sm:text-lg text-green-700";
  document.getElementById("decisionStrip").style.backgroundColor = "#005B95";
  recoEl.className = "text-sm font-semibold rounded-lg px-4 py-3 border-l-4 border-green-500 text-green-800";
  recoEl.style.backgroundColor = "#f0f7fc";

  if (savings <= 10000) {
    emojiEl.src = "assets/is-it-worth.gif";
    titleEl.textContent = "Nice offer, but worth it?";
  ...
  amountEl.className = "text-2xl font-extrabold text-red-600";
  titleEl.className = "text-base font-bold sm:text-lg text-red-700";
  document.getElementById("decisionStrip").style.backgroundColor = "#005B95";
  recoEl.className = "text-sm font-semibold rounded-lg px-4 py-3 border-l-4 border-red-500 text-red-800";
  recoEl.style.backgroundColor = "#f0f7fc";
  ...
  titleEl.className = "text-base font-bold sm:text-lg text-gray-600";
  labelEl.textContent = "No Gain / No Loss";
  amountEl.textContent = "₹0";
  amountEl.className = "text-2xl font-extrabold text-gray-500";
  document.getElementById("decisionStrip").style.backgroundColor = "#005B95";
  recoEl.className = "text-sm font-semibold rounded-lg px-4 py-3 border-l-4 border-gray-400 text-gray-600";
  recoEl.style.backgroundColor = "#f0f7fc";
  recoEl.textContent = "When the total cost is about the same, then why waste your time.";
}
